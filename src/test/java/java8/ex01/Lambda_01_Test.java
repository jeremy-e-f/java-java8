...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        PersonPredicate filtreAge= person -> person.getAge()>= 18;
        List<Person> result = filter(personList, filtreAge);
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate filtrePrenom= person -> person.getFirstname().equals("first_10");
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate filtrePerson= person -> person.getAge() > 49 && DigestUtils.sha512Hex(person.getPassword()).equals(passwordSha512Hex);
        List<Person> result = filter(personList, filtrePerson);
