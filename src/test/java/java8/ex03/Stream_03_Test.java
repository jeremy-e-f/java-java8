...
public class Stream_03_Test {
    ...
    public void test_joining() throws Exception {
        ...
        String result = customers.stream().map(Customer::getFirstname).sorted((fn1,fn2)->fn1.compareTo(fn2)).collect(Collectors.joining("|"));
    ...
    public void test_mapping() throws Exception {
        ...
        //Map<Gender, String> result = customers.stream().collect(groupingBy(Customer::getGender,Collectors.joining("|")));
        
        Map<Gender, String> result = customers.stream().collect(groupingBy(Customer::getGender,Collectors.joining("|")));
        	//	(groupingBy(Customer::getGender,Collectors.joining("|")));
